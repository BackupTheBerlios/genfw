...
public class EcoreHelper
{
  ...
  public static Resource createXMLResource(String pathName)
  {
    ...
    {
      logger.error("Problem while creating XML resource " + pathName, ex);
      return null;
    }
  }
  ...
  public static boolean putXMLObject(String pathName, EObject object)
  {
    ...
    {
      logger.error("Problem while saving XML resource " + pathName, ex);
    }
    return false;
  }
  ...
  public static Resource getXMIResource(String pathName)
  {
    ...
    {
      logger.error("Problem while loading XMI resource " + pathName, ex);
      return null;
    }
  }
  ...
  public static Resource createXMIResource(String pathName)
  {
    ...
    {
      logger.error("Problem while creating XMI resource " + pathName, ex);
      return null;
    }
  }
  ...
  public static boolean putXMIObject(String pathName, EObject object)
  {
    ...
    {
      logger.error("Problem while saving XMI resource " + pathName, ex);
    }
    return false;
  }
  ...
  public static Set<EPackage> getSubPackages(EPackage basePackage, boolean includeBasePackage)
  {
  ...
  private static void collectSubPackages(EPackage basePackage, Set<EPackage> result)
  {
  ...
  public static Set<EClass> getAllSubClasses(EClass baseClass, boolean includeBaseClass,
  ...
  private static void includeClass(EClassifier classifier, boolean includeInterfaces,
          boolean includeAbstracts, Set<EClass> result)
  {
