...
public class ContentProvidersExtension
{
  protected ContentProvidersExtension(Object parent, IExtension origin)
  {
    ...
    for (IConfigurationElement element : configurationElements)
    {
      ...
      if ("contentProvider".equals(element.getName())) contentProviderElements.add(new ContentProvider(this, element));
    }
  }
  ...
  public List<ContentProvider> getContentProviderElements() { return Collections.unmodifiableList(contentProviderElements); }
  ...
  public List getAllElements()
  {
    ...
    result.add(this);
    for (ContentProvider element : contentProviderElements) result.addAll(element.getAllElements());
    return result;
  }
}
