...
public class ExternalLibrariesExtension
{
  protected ExternalLibrariesExtension(Object parent, IExtension origin)
  {
    ...
    for (IConfigurationElement element : configurationElements)
    {
      ...
      if ("externalLibrary".equals(element.getName())) externalLibraryElements.add(new ExternalLibrary(this, element));
    }
  }
  ...
  public List<ExternalLibrary> getExternalLibraryElements() { return Collections.unmodifiableList(externalLibraryElements); }
  ...
  public List getAllElements()
  {
    ...
    result.add(this);
    for (ExternalLibrary element : externalLibraryElements) result.addAll(element.getAllElements());
    return result;
  }
}
