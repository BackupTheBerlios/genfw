...
{
  public static final String EXT_POINT_ID = "com.sympedia.genfw.domTransformations";

  public static final DomTransformationsRegistry INSTANCE = new DomTransformationsRegistry();

  private List<DomTransformationsExtension> domTransformations = new ArrayList<DomTransformationsExtension>();

  private List<Listener> listeners = new ArrayList<Listener>();

  private boolean initialized = false;

  public DomTransformationsRegistry()
  {
  }

  public List<DomTransformationsExtension> getDomTransformations()
  {
    return Collections.unmodifiableList(domTransformations);
  }

  public List getAllElements()
  {
    List result = new ArrayList();
    for (DomTransformationsExtension extension : domTransformations)
    {
  ...
  public List<DomTransformation> getAllDomTransformationElements()
  {
  ...
  private void addExtension(IExtension origin, ChangeEvent event)
  {
    try
    {
      DomTransformationsExtension extension = new DomTransformationsExtension(null, origin);
      domTransformations.add(extension);
  ...
  private void removeExtension(IExtension origin, ChangeEvent event)
  {
    ...
    for (DomTransformationsExtension extension : extensions)
    {
      ...
      {
        domTransformations.remove(extension);
  ...
  public class ChangeEvent
  {
    ...
    private void dispatch()
    {
      ...
      for (Listener listener : listeners)
      {
        try
        {
          listener.notifyDomTransformationsRegistryChanged(this);
        }
        catch (Exception ex)
        {
          ex.printStackTrace();
