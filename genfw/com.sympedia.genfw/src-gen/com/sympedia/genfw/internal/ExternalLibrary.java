...
public class ExternalLibrary
{
  protected ExternalLibrary(Object parent, IConfigurationElement origin)
  {
    ...
    if (libraryPath == null || libraryPath.length() == 0)
      throw new RuntimeException("LibraryPath is required");
    libraryInitializer = origin.getAttribute("libraryInitializer");
    if (libraryInitializer == null || libraryInitializer.length() == 0)
      throw new RuntimeException("LibraryInitializer is required");
  ...
  public com.sympedia.genfw.IExternalLibraryInitializer getLibraryInitializer()
          throws CoreException
  {
    return (com.sympedia.genfw.IExternalLibraryInitializer)_origin
            .createExecutableExtension("libraryInitializer");
  }
