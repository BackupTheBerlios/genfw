 ...
 * </copyright>
 *
 * $Id: SwtSwitch.java,v 1.2 2006/04/06 20:54:24 stepper Exp $
 */
...
public class SwtSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case SwtPackage.GIF_OVERLAYER: {
			GifOverlayer gifOverlayer = (GifOverlayer) theEObject;
			Object result = caseGifOverlayer(gifOverlayer);
			if (result == null)
				result = caseGenerator(gifOverlayer);
			if (result == null)
				result = caseLifeCycle(gifOverlayer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SwtPackage.CREATE_CHILD_OVERLAYER: {
			CreateChildOverlayer createChildOverlayer = (CreateChildOverlayer) theEObject;
			Object result = caseCreateChildOverlayer(createChildOverlayer);
			if (result == null)
				result = caseGifOverlayer(createChildOverlayer);
			if (result == null)
				result = caseGenerator(createChildOverlayer);
			if (result == null)
				result = caseLifeCycle(createChildOverlayer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Gif Overlayer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Gif Overlayer</em>'.
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Create Child Overlayer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Create Child Overlayer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
