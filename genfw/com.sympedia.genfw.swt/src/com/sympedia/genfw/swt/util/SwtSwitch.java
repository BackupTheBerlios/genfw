 ...
 * </copyright>
 *
 * $Id: SwtSwitch.java,v 1.1 2006/03/06 07:56:47 stepper Exp $
 */
...
public class SwtSwitch
{
  ...
  protected Object doSwitch(int classifierID, EObject theEObject)
  {
    ...
    case SwtPackage.GIF_OVERLAYER:
    {
      ...
      if (result == null) result = caseGenerator(gifOverlayer);
      if (result == null) result = caseLifeCycle(gifOverlayer);
